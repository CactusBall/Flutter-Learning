...
import 'package:flutter_app/page/PostPage.dart';
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            ...
            switch (snapshot.connectionState) {
              ...
              case ConnectionState.waiting:
                return new Center(child: ext.buildLoadingIndicator());
              ...
              default:
                if (snapshot.hasError) {
                  ...
                  List<dom.Element> container =
                      document.getElementsByClassName("u-full-width");
                  List<dom.Element> elements =
                      container[0].getElementsByClassName("title");
                  List<dom.Element> times =
                      container[0].getElementsByClassName("time");

                  mPost.clear();
                  elements.forEach((element) {
                    List<dom.Element> head = element.getElementsByTagName('a');
                    List<dom.Element> author =
                        element.getElementsByTagName('small');
                    //print(head[0].text);
...
class Post {
  ...
  Map<String, dynamic> toJson() =>
      {"desc": desc, "publishAt": publishAt, "who": who, "url": url};
}
